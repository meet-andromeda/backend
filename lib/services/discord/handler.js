...
const send_discord_message_1 = require("./helpers/send-discord-message");
const middlewares = [
    (0, add_post_cors_1.default)(),
    (0, http_error_handler_1.default)(),
];
exports.main = (0, core_1.default)(async (event) => {
    const { body } = event;
    const requestBody = JSON.parse(body);
    const { title, params, url, } = requestBody;
    await (0, send_discord_message_1.sendDiscordMessage)({
        title,
        params,
        url,
    });
